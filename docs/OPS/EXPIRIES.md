...
| E8 | Cognee keys | UNVERIFIED — not found in repo | **UNVERIFIED** | Vishnu | No reference to Cognee found under `apps/` on `main` @ `40d2297`. Confirm whether this is still in scope. |
