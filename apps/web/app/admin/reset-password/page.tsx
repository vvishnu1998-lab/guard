...
function ResetPasswordForm() {
  ...
  async function handleSubmit() {
    setError('');
    if (password.length < 6 || password.length > 8) { setError('Password must be 6–8 characters.'); return; }
  ...
  return (
    <main className="min-h-screen bg-[#060E1A] flex items-center justify-center p-8">
      <div className="w-full max-w-[380px]">
        ...
        <p className="text-white/35 text-sm mb-10 tracking-wide">Admin portal password reset.</p>
