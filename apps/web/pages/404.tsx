export default function Custom404() {
  return (
    <main style={{ minHeight: '100vh', background: '#1A1A2E', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 24, fontFamily: 'sans-serif' }}>
      <h1 style={{ fontSize: 64, fontWeight: 700, color: '#FBBF24', letterSpacing: 8, margin: 0 }}>404</h1>
      <p style={{ color: '#9CA3AF', letterSpacing: 4, fontSize: 14, margin: 0 }}>PAGE NOT FOUND</p>
